...
public class WildernessActivity extends AppCompatActivity {
    ...
    public static Player getPlayer(Intent intent) {
        Bundle data = intent.getExtras();
        return (Player) data.getParcelable(PLAYER);
    }
    ...
    public void checkWin() {
        ...
        {
            if(equipment.getDescription().equals("Jade Monkey")) count++;
            else if(equipment.getDescription().equals("Ice Scraper")) count++;
            else if(equipment.getDescription().equals("Road Map")) count++;
        }
